...
//import static com.bb3.bodybuddybe.gym.dto.KakaoApiResponseDto.Meta;
...
//        when(kakaoApiClient.fetchPlacesFromKakaoAPI(query, location)).thenReturn(mockResponse.getDocuments());
//
//        // when
